...
OFFERS = [
  ...
  { key: :offer7,  request: :request5,  donor: :donor1, condition: "new",            quantity_offered: 20, status: "received",  can_ship_by: 5.days.ago.to_date,       message: "Delivered, ready for feedback" }
].freeze
